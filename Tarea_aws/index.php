...
<body style="background: linear-gradient(135deg, #FF9900, #FF6600, #0066CC, #333333);">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link" href="/index.php" aria-current="page">Inicio <span
                                class="visually-hidden">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link disabled" style="color:black;" href="proyectos/aws">Cartelera de
                            Peliculas</a>
                    </li>
                    <li class="nav-item">
    ...
    <style>
        ...
        .card:hover {
            ...
            box-shadow: 0 0 20px rgba(57, 255, 20, 0.8), 0 0 40px rgba(57, 255, 20, 0.6), 0 0 60px rgba(57, 255, 20, 0.4);
        }
    </style>
    <main>
        <div class="container mt-5">
            <div class="card" style="width: 18rem;">
                <img src="https://s3.us-east-1.amazonaws.com/dinnigog01.app.proyecto/CARTELERA-CARTEL-01.png"
                    class="card-img-top" alt="Cartelera de Peliculas">
                <div class="card-body">
                    <h5 class="card-title">Cartelera de Peliculas</h5>
                    <p class="card-text">Explora las últimas películas disponibles en la nube con nuestro sistema de
                        cartelera.</p>
            ...
            <div class="card mt-4" style="width: 18rem;">
                <div class="card-body">
                    ...
                    <a href="https://www.awsacademy.com/vforcesite/LMS_Login">
                        <img src="https://www.awsacademy.com/vforcesite/resource/1576451101000/logo"
                            alt="AWS Academy Logo" class="img-fluid" style="background-color: #333333;">
                    </a>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container text-center">
            <p>Desarrollado por <a href="https://github.com/daniinigogarcia98" target="_blank" class="text-white">Daniel
                    Iñigo García</a></p>
            <div>
