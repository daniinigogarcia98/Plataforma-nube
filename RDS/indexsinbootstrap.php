            ...
            <form action="" method="post">
                <table border="1">
                    ...
                    foreach ($tareas as $t) {
                        ...
                        echo '<td> <button type="submit" value=' . $t->getId() . ' name="empezar"' . ($t->getEstado() != 'pendiente' || $t->getEstado() == 'completada' ? 'style="display:none"' : '') . '>Empezar</button> <button type="submit" value=' . $t->getId() . ' name="terminar"' . ($t->getEstado() != 'en proceso' || $t->getEstado() == 'completada' ? 'style="display:none"' : '') . '>Terminar</button> <button type="submit" value=' . $t->getId() . ' name="borrar">Borrar</button> </td>';
                        echo '</tr>';
                    } ?>
                </table>
            </form>
